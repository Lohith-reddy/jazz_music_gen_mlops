...
def train(model, network_input, network_output, epochs=200, batch_size=128, validation_split=0.2):
    ...
    network_input_train, network_input_val, network_output_train, network_output_val = train_test_split(
        network_input, network_output, test_size=validation_split
    )

    # Include validation_data in the fit method
    model.fit(
        network_input_train,
        network_output_train,
        epochs=epochs,
